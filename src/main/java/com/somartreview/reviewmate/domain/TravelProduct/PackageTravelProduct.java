...
public class PackageTravelProduct extends TravelProduct {
    ...
    public PackageTravelProduct(String partnerPackageTravelProductId, String thumbnailUrl, String name, Category category, PartnerCompany partnerCompany, PartnerSeller partnerSeller) {
        super(partnerPackageTravelProductId, thumbnailUrl, name, category, partnerCompany, partnerSeller);
    }
