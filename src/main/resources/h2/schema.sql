...
create table live_feedback (live_feedback_id bigint generated by default as identity, created_at timestamp, updated_at timestamp, feedback_media_url varchar(1024), feedback_message varchar(255) not null, is_handled boolean not null, is_reported boolean not null, is_solved boolean not null, response_message varchar(255), reservation_id bigint, primary key (live_feedback_id))
