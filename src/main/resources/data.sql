...
VALUES ('2023-08-30 12:00:00', '2023-08-30 12:00:00', 'sckwon770kakao', '권순찬', '010-1234-1234', 1);
...
INSERT INTO travel_product (dtype, created_at, updated_at, name, partner_custom_id, rating, thumbnail_url, category, end_time, start_time, partner_company_id, partner_seller_id)
VALUES ('2023-08-30 12:00:00', '2023-08-30 12:00:00', '신라더스테이 호텔 - 스위트룸', 'HOTEL-0001', 0, testurl.com, 'ACCOMMODATION', '36:00:00', '13:00:00', 1, 1);

INSERT INTO reservation (created_at, updated_at, start_date, customer_id, travel_product_id)
VALUES ('2023-08-30 12:00:00', '2023-08-30 12:00:00', '2023-10-18', 1, 1);
...
INSERT INTO review (created_at, updated_at, polarity, content, rating, title, customer_id, travel_product_id)
VALUES ('2023-09-01 12:00:00', '2023-09-01 12:00:00', 'POSITIVE', '리뷰 내용 1', 5, '리뷰 제목 1', 1, 1);
